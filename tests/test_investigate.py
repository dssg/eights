...
from eights.investigate.investigate import describe_cols
...
from eights.investigate.investigate import open_csv_as_structured_array, describe_cols,open_csv_as_list,cast_list_of_list_to_sa, crosstab
