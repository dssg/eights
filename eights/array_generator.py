...
class ArrayGenerator(object):
    ...
    **Taking subsets of units**
    ...
    def set_aggregation(self, feature_name, method):
        """Sets the method used to aggregate across dates in a log table.
    ...
    def set_constraint(self, where):
        """
        
        Specifies a subset of the units to be returned in the SA according
        to some constraint.
    ...
    def to_sa(self, start_time, stop_time):
        """Creates a structured array
